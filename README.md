...
입력된 고객 정보를 바탕으로 추천 상품을 가져올 때, 추천 내역을 기록하는 API를 개발하는 과제입니다.  
...
```
git clone https://github.com/bgpark82/musinsa
```
...
| 한글명 | 영문명 | 설명                |
| --- | --- |-------------------|
| 고객 이름 | name | 상품 추천하려는 고객의 이름   |
| 이메일 | email | 상품 추천하려는 고객의 이메일  |
| 성별 | gender | 상품 추천하려는 고객의 성별   |
| 추천 상품 요청 횟수 | requestCount | 상품 추천 호출 횟수       |
